...
export default function CompanyCard({ company, isSelected, onSelect }) {
  return (
    ...
    <div
      className={`border rounded-lg p-4 shadow-sm relative cursor-pointer transition
        ${isSelected ? "border-blue-500 bg-[#ddbbae]" : "border-gray-200"}
      `}
      onClick={onSelect}
    >
      ...
      <div className="mt-4 flex items-center justify-end gap-2">
        ...
        <button className="rounded-lg border px-3 py-1.5 text-sm active:scale-95">
