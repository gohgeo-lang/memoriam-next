...
const steps = [
  {
    ...
    icon: <FaPhoneAlt size={32} className="text-[#856056] mb-3" />,
  },
  {
    number: "02",
    title: "염습 및 입관",
    desc: "반려동물의 몸을 닦고 정리하는 염습 과정 진행 후, 의복을 입히고 관에 안치합니다.",
    icon: <FaRegHeart size={32} className="text-[#856056] mb-3" />,
  },
  {
    number: "03",
    title: "추모식 및 마지막 인사",
    desc: "단독 빈소에서 보호자와 반려동물이 마지막 인사를 나눕니다.",
    icon: <FaRibbon size={32} className="text-[#856056] mb-3" />,
  },
  {
    number: "04",
    title: "화장 및 유골 수습",
    desc: "보호자 참관 하 개별 화장이 진행되며, 완료 후 유골을 수습하고 한지 주머니나 유골함에 담아 전달합니다.",
    icon: <FaFire size={32} className="text-[#856056] mb-3" />,
  },
  {
    number: "05",
    title: "유골 전달 및 안치",
  ...
  },
  {
    ...
    icon: <FaRegFileAlt size={32} className="text-[#856056] mb-3" />,
  },
];

export default function ProcedureSteps() {
  return (
    <section className="py-12 lg:py-16 bg-[#f9f5f3]">
          ...
          {steps.map((step) => (
            ...
            >
              <div className="flex flex-col items-center text-center">
                {step.icon}
                <div className="text-[#856056] text-xl font-bold mb-3">
