...
export default function Home() {
  return (
    <>
      ...
      {/* 2. 온라인 추모 공간 (Full-Screen Welcome) */}
      {/* 여기에도 'flex', 'justify-center', 'items-center', 'py-20' 적용 */}
      <section className="relative min-h-screen text-center overflow-hidden px-5 flex flex-col justify-center items-center py-20">
        <Image
        ...
        <div className="relative z-20 max-w-2xl mx-auto">
          ...
          <p className="text-lg text-gray-200 mx-auto mb-8 [text-shadow:0_1px_2px_rgba(0,0,0,0.8)]">
            함께 이 세계를 여행했으나, 먼저 떠난 아이들의 이야기
            <br />
            따뜻한 위로의 마음을 나눌 수 있는 온라인 추모 공간입니다.
          </p>
          <Link href="/service/memoriam">
            <button className="bg-white text-[#7b5449] font-semibold px-8 py-3 rounded-xl active:bg-gray-200 active:scale-[0.98] transition-all">
              추모 공간 둘러보기
            </button>
          </Link>
        </div>
      ...
      {/* 3. 메모리엄이 전하는 가치 섹션 - <Section> 컴포넌트 사용 */}
